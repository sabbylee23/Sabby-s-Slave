...
function renderWorkoutChoice() {
  app.innerHTML = `
    <section class="hero-panel">
      ...
      <p>All activities track duration and cardio load. Gym also logs exercises.</p>
    </section>

    <section class="grid">
      ${activityButton("Gym", "Exercises, duration, cardio load", "gym")}
      ${activityButton("Cycling", "Duration and cardio load", "cycling")}
      ${activityButton("Badminton", "Duration and cardio load", "badminton")}
