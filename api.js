const LifeDashboardApi = (() => {
  const CONFIG = {
    ...
    appsScriptUrl: "https://script.google.com/macros/s/AKfycbwFPMXnsU7-Lk7Z4Lin9pH4_7VRTY9pAXqw8Er0apM5K4vSZa5LReX3xCGulFQM94cz/exec",
  };
  ...
  const starterData = {
    exercises: [
      { id: "EX001", name: "Bench Press", category: "Upper Body", active: true },
      { id: "EX002", name: "Incline DB Press", category: "Upper Body", active: true },
      { id: "EX003", name: "Cable Fly", category: "Upper Body", active: true },
      { id: "EX004", name: "Lat Pulldown", category: "Upper Body", active: true },
      { id: "EX005", name: "Seated Cable Row", category: "Upper Body", active: true },
      { id: "EX006", name: "Shoulder Press", category: "Upper Body", active: true },
      { id: "EX007", name: "Lateral Raise", category: "Upper Body", active: true },
      { id: "EX008", name: "Squat", category: "Lower Body", active: true },
      { id: "EX009", name: "Romanian Deadlift", category: "Lower Body", active: true },
      { id: "EX010", name: "Plank", category: "Core", active: true },
    ],
    gymLog: [],
    rehabLog: [],
    activityLog: [],
  ...
  function localRequest(action, payload) {
    ...
    if (action === "bootstrap") {
      ...
      return Promise.resolve({
        ...
        exercises: data.exercises.filter((exercise) => exercise.active).map(normalizeExercise),
  ...
  function normalizeExerciseCategory(category) {
    const value = String(category || "").trim();
    const lower = value.toLowerCase();
    if (["chest", "back", "shoulders", "arms", "full body"].includes(lower)) return "Upper Body";
    if (["legs", "lower"].includes(lower)) return "Lower Body";
    if (lower === "core") return "Core";
    if (lower === "rehab") return "Rehab";
    return value || "Upper Body";
  }
